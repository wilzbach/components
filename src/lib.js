...
import { faHeart, faClipboard, faClipboardCheck } from '@fortawesome/free-solid-svg-icons'
...
const VuePlugin = {
  install: function (Vue) {
    ...
    library.add(faHeart, faGithub, faSlack, faTwitter, faClipboard, faClipboardCheck)
